                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="dataNasc" name="dataNasc" value="<?=_v($dados,"dataNasc")?>" placeholder="DD/MM/AAAA" class="form-control input-md" required="" type="date" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                                </div>
                        ...
                        <div id="newpost">
                            ...
                            <?php if(!isset($dados['id'])):?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="cargo" required="required" class="form-control">
                                            ...
                                            <?php foreach ($cargos as $key => $item):?>
                                                ...
                                                <option <?= $item['id'] ?> value="<?= $item['id']?>"><?= $item["name"] ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="dataIngresso" value="<?=_v($dados,"dataIngresso")?>" name="dataIngresso" placeholder="DD/MM/AAAA" class="form-control input-md" required="" type="date" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
                                    </div>
