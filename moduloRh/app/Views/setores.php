                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Painel de Setores</li>
                        </ol>
                                        ...
                                        <?php foreach($setores as $key =>$item):?>
                                            <tr>
                                                <th>
                                                 ...
                                                 <!--EDIT-->
                                                <th >
                                                <a href="<?=site_url("SetorController/editSetor/{$item['id_Sector']}/{$item['name']}")?>">
                                                ...
                                                <!--DELETE-->
                                                <th>
                                                    <a href="<?=site_url("SetorController/deleteSetor/{$item['id_Sector']}")?>" onclick='return confirmDeleteSetor();'>
